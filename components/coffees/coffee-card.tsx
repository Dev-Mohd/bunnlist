      ...
      <Card className="flex h-full flex-col overflow-hidden transition duration-200 hover:-translate-y-1 hover:shadow-lg">
        ...
        <div className="flex flex-1 flex-col p-5">
          <div className="space-y-2">
            <p className="text-sm font-semibold text-amber-800">{coffee.roaster.name}</p>
            <h3 className="line-clamp-2 text-xl font-bold leading-7 text-stone-950">{coffee.name}</h3>
