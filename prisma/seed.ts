...
const roasters = [
  { name: "Camel Step Roasters", slug: "camel-step-roasters", country: "السعودية", city: "الرياض" },
  { name: "Half Million", slug: "half-million", country: "السعودية", city: "الرياض" },
  { name: "Mokhabz", slug: "mokhabz", country: "السعودية", city: "الرياض" },
];
